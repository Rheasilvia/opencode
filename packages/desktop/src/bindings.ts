...
export const commands = {
  ...
  startBrowserBridge: (cdpPort: number, wsPort: number) =>
    __TAURI_INVOKE<null>("start_browser_bridge", { cdpPort, wsPort }),
  stopBrowserBridge: () => __TAURI_INVOKE<null>("stop_browser_bridge"),
  getBridgeStatus: () => __TAURI_INVOKE<boolean>("get_bridge_status"),
}
